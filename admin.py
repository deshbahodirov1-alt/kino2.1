...
@router.message(F.text.lower() == "user")
...
async def menu_movies(message: Message):
...
@router.message(F.text.lower() == "groups")
...
async def admin_help(message: Message):
    ...
    text = (
        ...
        "🔥 Barcha commandlar faqat admin uchun ishlaydi."
    )
